...
**Notes**: Method signatures exactly match `ShippingServiceRemote.java:6-7` to ensure contract compatibility. Note that api paths can change but they must be consistently used across codebase.
